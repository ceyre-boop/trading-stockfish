"""Manual recovery run for PAPER day3.
...
LOG_PATH = LOG_DIR / "daily_day3_recovery.log"
RUN_ID = "day3"
...
def main() -> None:
    ...
    if audits < 1:
        errors.append("audits missing for day3 (expect >=1)")
    if stats < 1:
        errors.append("stats missing for day3")

    if errors:
        print("FAIL: Day3 recovery")
        for e in errors:
            print(f" - {e}")
        sys.exit(1)

    print("PASS: Day3 recovery")
