...
class BaseConnector(ABC):
    ...
    def log_stats(self):
        ...
        logger.info(f"  Updates: {s['updates_received']} received, {s['updates_normalized']} normalized")
        logger.info(f"  Orders: {s['orders_submitted']} submitted, {s['orders_filled']} filled")
        logger.info(f"  Errors: data={s['data_errors']}, connection={s['connection_errors']}")
